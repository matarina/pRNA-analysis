...
mirna_dict = read_fa("H:/chrome downlaod/data/homo_mature_mirna.fa")
mirna_list = list(mirna_dict.values())
train_doc2vec_model(mirna_dict,"mirna_doc2vec")

lncrna_dict = read_fa("H:/chrome downlaod/gencode.v33.lncRNA_transcripts.fa/gencode.v33.lncRNA_transcripts.fa")
...
mirna_model_path = "./mirna_doc2vec.model"
mirna_doc2vec_model = gensim.models.Doc2Vec.load(mirna_model_path)

lncrna_model_path = "./lncrna_doc2vec.model"
...
lncrna_dict = read_fa("H:/chrome downlaod/gencode.v33.lncRNA_transcripts.fa/gencode.v33.lncRNA_transcripts.fa")
mirna_dict = read_fa("H:/chrome downlaod/data/homo_mature_mirna.fa")
pairs_path = "H:/chrome downlaod/data/lnc_mir_pairs.txt"
...
save_dict(lnc_ctd_dict,"./lnc_ctd_dict.txt")
...
save_dict(lnc_role2vec_embedding,"./lnc_role2vec_dict.txt")

print("mirna graph")
mir_ctd_dict = load_dict("./mir_ctd_dict.txt")
mir_doc2vec_dict = load_dict("./mir_doc2vec_dict.txt")
mir_kmer_dict = load_dict("./mir_kmer_dict.txt")
...
save_dict(mir_role2vec_embedding,"./mir_role2vec_dict.txt")
